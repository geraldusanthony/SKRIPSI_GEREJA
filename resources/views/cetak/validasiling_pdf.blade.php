...
h1 { font: bold 100% sans-serif; letter-spacing: 0.4em; text-align: center; text-transform: uppercase; }
...
table.inventory td:nth-child(1) { text-align: center; width: 12%; }
	...
	@foreach ($view_data as $persembahanling)
		...
		<img src="asset/images/logogerejabaru.jpg" width="180"><img>
			...
			<address contenteditable>
				...
				<p>Jl. Gereja No.1, Gamping Lor, Ambarketawang, Kec. Gamping</p>
				<p>0274798748</p>
			</address>		
		</header>
		<header>
			<address contenteditable>
				<p>Tanda Terima Persembahan {{$persembahanling->ket}},
				Berikut merupakan rincian dari data persembahan : </p>		
			</address>		
...
<td style="width:200px; align:center; border:0px">Mengetahui {{$persembahanling->nama_ling}},<br><br><br><br><br>
<br><br>(__________________________)
</td>
</tr>
</table>
